...
var i18nElementsData = [
    ["title", 0, "EUD工具箱 v2.01"],
    ["#title_text", 0, "EUD工具箱 v2.01"],
    ["#label_offset", 0, "起始："],
    ["#label_length", 0, "长度："],
    ["#label_object", 0, "物体："],
    ["#label_memory", 0, "内存："],
    ...
    ["#toollinks_links", 3, " - 按钮修改工具"],
    ["#toollinks_links", 5, " - SC 1.16.1 内存表"],
    ["#toollinks_links", 7, " - SC 1.16.1 内存表（备份）"],
    ["#toollinks_links", 9, " - Iscript代码资料"],
    ["#toollinks_links", 11, " - 按钮图标列表"],
    ["#toollinks_links", 13, " - 按钮字符串列表"],
    ["#toollinks_links", 15, " - 读取/修改chk格式地图的字符串"],
    ["#toollinks_links", 17, " - 绘制二维码和小地图"],
    ...
    ["#label_stattbl_str", 0, "编号："],
    ["#label_stattbl_str2", 0, "编号2："],
    ["#label_stattbl_content", 0, "字符串："],
    ["#label_stattbl_batch", 0, "批量："],
    ["#parse_stattbl", 0, "生成"],
	...
	["#settings_label_hexoutput_memory",0,"地址格式："],
	["#settings_label_hexoutput_value",0,"数值："],
	["#settings_label_hexoutput_mask",0,"掩码："],
	["#settings_label_language",0,"语言："],
	["#settings_label_reverse_calc_object",0,"反向计算物体："],
	[".settings_header",0,"设置"],
	["#label_generate",0,"生成："],
	["#link_generate_condition",0,"条件"],
	["#link_generate_action",0,"效果"],
	["#link_generate_read_eud3",0,"读取"],
	["#link_generate_condition_eud3",0,"条件"],
	["#link_generate_action_eud3",0,"效果"],
	["#hover_offset_help",0,"说明"],
	[".library_header",0,"资料"],
	["#label_playercolor_tileset",0,"地形"],
	["#label_upg_player",0,"玩家："],
	["#label_upg_uid",0,"升级："],
	["#label_length_next",0,"／　"],
];
