...
var memorylist = [ /* format: memory, length, type (0:padding, 1:memory), description */
    ...
    [0x581D61, 1, 1, "Player Lose Type (Local)"],
    [0       , 0, 0, ""],
    [0       , 0, 0, "-----Trigger-----"],
    ...
    [0x5124D8, 4, 1, "Refresh Rate (each speed)"],
