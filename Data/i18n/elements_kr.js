...
var i18nElementsData = [
    ["title",0,"EUD 도구 상자 v2.01"],
	["#title_text",0,"EUD 도구 상자 v2.01"],
	["#label_offset",0,"시작："],
	["#label_length",0,"길이："],
	["#label_object",0,"물체："],
	["#label_memory",0,"기억："],
	...
	[".settings_hexoutput_dec",0,"소수"],
	[".settings_hexoutput_hex",0,"16진수"],
	...
	["#toollinks_links",3," - 버튼 수정 도구"],
	["#toollinks_links",5," - SC 1.16.1 메모리 테이블"],
	["#toollinks_links",7," - SC 1.16.1 메모리 테이블(백업)"],
	["#toollinks_links",9," - Iscript 코드 정보"],
	["#toollinks_links",11," - 버튼 아이콘 목록"],
	["#toollinks_links",13," - 버튼 문자열 목록"],
	["#toollinks_links",15," - 지도 문자열 읽기/수정"],
	["#toollinks_links",17," - QR코드와 미니맵 그리기"],
	["#label_etg_base",0,"템플릿："],
	...
	["#label_stattbl_str",0,"번호："],
	["#label_stattbl_str2",0,"2 번："],
	["#label_stattbl_content",0,"문자열："],
	["#label_stattbl_batch",0,"일괄："],
	...
	["#label_reqwrite_uid",0,"ID："],
	["#label_reqwrite_offset",0,"수요 편차："],
	["#label_reqwrite_add",0,"지침 추가："],
	["#settings_label_hexoutput_memory",0,"메모리 포맷："],
	["#settings_label_hexoutput_value",0,"값："],
	["#settings_label_hexoutput_mask",0,"마스크："],
	["#settings_label_language",0,"언어："],
	["#settings_label_reverse_calc_object",0,"역 계산 개체："],
	[".settings_header",0,"설정"],
	["#label_generate",0,"생성하다"],
	["#link_generate_condition",0,"상태"],
	["#link_generate_action",0,"동작"],
	["#link_generate_read_eud3",0,"읽다"],
	["#link_generate_condition_eud3",0,"상태"],
	["#link_generate_action_eud3",0,"동작"],
	["#hover_offset_help",0,"정보"],
	[".library_header",0,"정보"],
	["#label_playercolor_tileset",0,"타일셋"],
	["#label_upg_player",0,"플레이어"],
	["#label_upg_uid",0,"업그"],
	["#label_length_next",0,"／　"],
];
